...
const transformations = {
  ...
  flipX: (options, shaderInfo) => {
    const c0x = ensureFloat(options.beizerC0x || 0.5)
    const c0y = ensureFloat(options.beizerC0y || 0.5)

    const c1x = ensureFloat(options.beizerC1x || 0.5)
    const c1y = ensureFloat(options.beizerC1y || 0.5)
